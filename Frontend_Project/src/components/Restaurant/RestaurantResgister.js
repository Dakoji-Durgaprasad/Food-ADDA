    ...
    return(
        ...
        <form className="px-5">
            ...
            <div className="row mb-4">
                <div className="col">
                  <input type="text" className="form-control" placeholder="Enter Your Restaurant name" aria-label="First name" required/>
                </div>
                <div className="col">
                  <input type="text" className="form-control" placeholder="Enter Restaurant Owner name" aria-label="Last name" required/>
                </div>
            </div>
            <div className="row mb-4">
                <div className="col">
